...
class ThemeConfig {
  static final ThemeData lightTheme = ThemeData(
      ...
      textTheme: TextTheme(
        ...
        subtitle1:
            CustomTextStyle.subHeading1.copyWith(color: NeutralColor.active),
        subtitle2:
            CustomTextStyle.subHeading2.copyWith(color: NeutralColor.active),
        bodyText1: CustomTextStyle.body1.copyWith(color: NeutralColor.active),
        bodyText2: CustomTextStyle.body2.copyWith(color: NeutralColor.active),
        headline4:
  ...
  static final ThemeData darkTheme = ThemeData(
      ...
      textTheme: TextTheme(
        ...
        bodyText1: CustomTextStyle.body1.copyWith(color: NeutralColor.offWhite),
        bodyText2: CustomTextStyle.body2.copyWith(color: NeutralColor.offWhite),
        headline4:
